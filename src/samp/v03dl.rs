...
// SA:MP 0.3.DL-R1 offsets - BlastHackNet/mod_sa samp-03dl branch (potvrdjeno)
pub const CNETGAME: usize = 0x2ACA24;                   // SAMP_INFO_OFFSET
pub const CINPUT: usize = 0x2ACA14;                     // SAMP_CHAT_INPUT_INFO_OFFSET
pub const CGAME: usize = 0x2ACA3C;                      // SAMP_MISC_INFO
pub const CGAME_SETCURSORMODE: usize = 0xA0530;         // SAMP_FUNC_TOGGLECURSOR
pub const CGAME_PROCESSINPUTENABLING: usize = 0xA0410;  // SAMP_FUNC_CURSORUNLOCKACTORCAM
pub const CDIALOG: usize = 0x2AC9E0;                    // dialog info offset
pub const CDEATHWINDOW_DRAW: usize = 0x6D5A0;           // procjena; treba verifikaciju
